...
def train_MeanTeacher_dropout(args,epochs, batch_size, alpha, lr, ratio,x_train, y_train, x_test, y_test, x_unlabel_tar,vocab_size, tokenizer,maxlen):
    ...
    for epoch in range(1,epochs+1):  
        ...
        for step, (x_batch_train, y_batch_train) in enumerate(train_dataset):
             with tf.GradientTape() as tape:
                ...
                x_batch_dp= drop_out(x_batch_train.numpy(),args.dropout)
                ...
                x_batch_dp1= drop_out(x_batch_train.numpy(),args.dropout)
